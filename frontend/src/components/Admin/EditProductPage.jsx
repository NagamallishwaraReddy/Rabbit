...
const EditProductPage = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
        <h2 className='text-3xl font-bold mb-6'>Edit product

        </h2>
        <form className='border-gray-1000' onSubmit={handleSubmit}>
            <div className='mb-6'>
            ...
            {/* escription */}
               ...
               <textarea name="description" value={productData.description} className='w-full boeder border rounded-md p-2'
               rows={4}
               onChange={handleChange}
               required>
            ...
            {/* Count in stock */}
                ...
                <input type="number" name="countInStock" value={productData.stock}
                onChange={handleChange}
                className='w-full border rounded-md  p-2'
            ...
            <div className='mb-6'>
                ...
                <div className='flex gap-4 mt-4'>
                    {productData.images.map((image,index)=>(
                        <div key={index}>
                            <img src={image.url} alt={image.alText||"Product Image"}
