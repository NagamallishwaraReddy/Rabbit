...
const FilterSidebar = () => {
    ...
    const [priceRange,setPriceRanges]=useState([0,100]);
...
"Navy",
    ...
    const params=Object.fromEntries([...searchParams])
        ...
        setFilters({
          ...
          setPriceRanges([0,params.maxPrice||100]);
          },[searchParams]);
...
const updateURLParams=(newFilters)=>{
    ...
    navigate(`?${params.toString()}`);//?category=Bottom

};
const handlePriceChange =(e)=>{
    const newPrice=e.target.value;
    setPriceRanges([0,newPrice])
                ...
                <label className='block text-gray-600 font-medium mb-2'>Category</label>
                    ...
                    (
                       ...
                       <input type='radio' name='category'
                        className='mr-2 h-4 w-4 text-blue-500 focud:ring-blue-400 border-gray-300'
                        value={category}
